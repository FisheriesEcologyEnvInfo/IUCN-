...
**Table I-** Mean size and total catch per type of cast. LANMAM = casts with tuna and dolphins, LANATUN = casts on free swimming tuna, LANPALO = casts ontuna with FADS.
...
ggplot(change, aes(Species, Change)) +
  ...
  labs(x='Species',y='% Change in Mean density of adults (individuals per 100m2 of reef)')
```
