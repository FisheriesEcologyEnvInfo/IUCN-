...
- *Pterois volitans*
    - Dietary items
    - Length - Weight
- Mexican Tuna Purse Seine fleet
      - Catch data (2013 & 2014)
      - Landings (2000 - 2013)
- Kelp forest (TURF-reserve vs. fishing)
    - Fish
    - Invertebrates
    - Algal cover
    - Habitat
...
```{r, echo=TRUE, fig.cap="Map of sampling sites for *P. volitans*"}
...
# We make a map
newmap=get_map(location=c(longitude=-87.25, latitude=20.45), zoom=12, maptype="watercolor")
ggmap(newmap)+
...
```{r, echo=TRUE, fig.cap="Length - Weight relationship for *P. volitans*"}
