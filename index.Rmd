...
We will submit our story and data to a http://datamares.ucsd.edu/eng/ 
...
if(CHItest$p.value<.05){print("There was a significant association between fish class and habitat system")}else{print("There was no significant association between fish class and habitat system")}
