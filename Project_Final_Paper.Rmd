...
Our project was focused on the exploration and visualization of data from the International Union for Conservation of Nature and Natural Resources (IUCN) Red List (IUCN 2015). Specifically, we examined marine fish species from the Red List with a particular interest in threatened species and their distributions worldwide.

The scientific question we explored was how are
